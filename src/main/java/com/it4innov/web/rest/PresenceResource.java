...
public class PresenceResource {
    ...
    public ResponseEntity<PresenceDTO> partialUpdatePresence(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, presenceDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<PresenceDTO> getPresence(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deletePresence(@PathVariable("id") Long id) {
